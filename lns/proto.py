...
def _protocol_handler(lnsd):
    ...
    try:
        ...
        # Assume, in this case, that the network has failed us. The wrapper
        # that is used to invoke this function should take care of restarting
        # us.
        return
